...
EVENTS_2025_STR = """【2025年 象徴的な出来事とサイン解読リスト（決定版）】

■ 国家プロジェクト・国民的行事
- 大阪・関西万博（EXPO 2025）開催
   - 内容: 「いのち輝く未来社会のデザイン」を掲げ、4月13日から半年間開催される国家的祭典。
   - サイン解読の鍵: 4、13（開始日）、10、13（終了日）、赤・青（ロゴ色/3枠4枠）、ミャクミャク（赤）、関西所属馬・騎手

- 昭和100年（昭和元年=1926年から100年目）
   - 内容: 改元がなければ昭和100年となる節目の年。レトロブームや昭和回顧が最高潮に。
   - サイン解読の鍵: 100、1、10、昭和生まれの騎手（武豊、横山典弘、小牧太など）、馬名に「百」「セン」

- 戦後80年・平和祈念
   - 内容: 終戦から80年の節目。「平和」「和」が改めて強調される年。
   - サイン解読の鍵: 80、8、和（馬名に「ワ」「カズ」・種牡馬など）、鳩（平和の象徴＝8、10）

- 新紙幣発行から1周年
   - 内容: 渋沢栄一らが描かれた新紙幣が完全に社会に定着。
   - サイン解読の鍵: 1、10000、栄（エイ・サカエ）、金（カネ・ゴールド）

■ スポーツ（国際大会・ビッグゲーム）
- MLB 開幕戦 東京シリーズ（ドジャース vs カブス）
   - 内容: 3月18・19日、東京ドームで開催。大谷翔平らが凱旋する歴史的開幕戦。
   - サイン解読の鍵: 17（大谷）、18、19（開催日）、青（両チーム色/4枠）、アメリカ、二刀流（芝ダート兼用馬）

- 世界陸上競技選手権大会（東京大会）
   - 内容: 9月13日〜21日、国立競技場開催。世界最速のアスリートが集結。
   - サイン解読の鍵: 9、13、21、走（馬名に「ラン」）、速（「スピード」「ファスト」）、金メダル

- 夏季デフリンピック（東京大会）
   - 内容: 11月15日〜26日開催。100周年記念大会にして日本初開催。
   - サイン解読の鍵: 100、11、15、手・耳（馬名や身体的特徴）、サイレント

■ エンターテインメント・文化（周年・象徴）
- 巳年（乙巳・きのとみ）
   - 内容: 2025年の干支。脱皮と再生、執念深さの象徴。
   - サイン解読の鍵: 6（十二支の6番目）、蛇（スネーク、サーペント、ドラゴン）、曲がりくねったもの、復活（長期休養明け）

- スーパー戦隊シリーズ 50周年
   - 内容: 「ゴレンジャー」から続く特撮ヒーロー50作目の金字塔。
   - サイン解読の鍵: 50、5、レンジャー（馬名）、正義、ヒーロー、5色の枠（白黒赤青黄＝1〜5枠）

- スーパーマリオブラザーズ 40周年
   - 内容: 世界的ゲームキャラクターの記念年。任天堂エリア拡張とも連動。
   - サイン解読の鍵: 40、M（馬名イニシャル）、赤（マリオ/3枠）、緑（ルイージ/6枠）、星（スター）

- GLAY デビュー30周年フィナーレ
   - 内容: 国民的ロックバンドの周年イヤー完結。
   - サイン解読の鍵: 30、3、灰（芦毛馬、グレーの勝負服）、誘惑、ソウルラブ

■ 新名所・巨大施設（ランドマーク）
- JUNGLIA（ジャングリア）開業（沖縄北部）
   - 内容: 世界自然遺産「やんばる」に誕生する大型テーマパーク。
   - サイン解読の鍵: 7（夏開業）、緑（6枠）、ジャングル、野性、恐竜

- TAKANAWA GATEWAY CITY（高輪ゲートウェイシティ）街びらき
   - 内容: 3月下旬、山手線最新駅の周辺開発が完了し本格稼働。
   - サイン解読の鍵: 3、ゲート（発走ゲート）、輪（オリンピック、リング）、新駅、港区

- グラングリーン大阪（うめきた2期）南館開業
   - 内容: 3月21日開業。大阪駅直結の巨大な「みどり」の空間。
   - サイン解読の鍵: 3、21、緑（6枠）、公園（パーク）、西の玄関口
"""
...
def sign_betting(client, events, numbers):
    system_prompt = f"""サイン理論から2025年有馬記念の買い目を導出してください。人気や実績は考慮に入れずに、2025年の出来事に関連する数字のみを用いて買い目を考えてください。
{HORSE_INFO_STR_2025}
