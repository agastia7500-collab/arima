...
# ============================================
HORSE_LIST_2025 = {
    1: {"枠番": 1, "馬番": 1, "馬名": "エキサイトバイオ", "性齢": "牡3歳", "騎手": "荻野極", "血統": "エイシンフラッシュ", "前走": "菊花賞3着"},
    2: {"枠番": 1, "馬番": 2, "馬名": "シンエンペラー", "性齢": "牡4歳", "騎手": "坂井瑠星", "血統": "Siyouni", "前走": "ジャパンC8着"},
    3: {"枠番": 2, "馬番": 3, "馬名": "ジャスティンパレス", "性齢": "牡6歳", "騎手": "団野大成", "血統": "ディープインパクト", "前走": "ジャパンC5着"},
    4: {"枠番": 2, "馬番": 4, "馬名": "ミュージアムマイル", "性齢": "牡3歳", "騎手": "C.デムーロ", "血統": "リオンディーズ", "前走": "天皇賞秋2着"},
    5: {"枠番": 3, "馬番": 5, "馬名": "レガレイラ", "性齢": "牝4歳", "騎手": "C.ルメール", "血統": "スワーヴリチャード", "前走": "エリザベス女王杯1着"},
    6: {"枠番": 3, "馬番": 6, "馬名": "メイショウタバル", "性齢": "牡4歳", "騎手": "武豊", "血統": "ゴールドシップ", "前走": "天皇賞秋6着"},
    7: {"枠番": 4, "馬番": 7, "馬名": "サンライズジパング", "性齢": "牡4歳", "騎手": "鮫島克駿", "血統": "キタサンブラック", "前走": "チャンピオンズC8着"},
    8: {"枠番": 4, "馬番": 8, "馬名": "シュヴァリエローズ", "性齢": "牡7歳", "騎手": "北村友一", "血統": "キズナ", "前走": "京都大賞典2着"},
    9: {"枠番": 5, "馬番": 9, "馬名": "ダノンデサイル", "性齢": "牡4歳", "騎手": "戸崎圭太", "血統": "エピファネイア", "前走": "ジャパンC3着"},
    10: {"枠番": 5, "馬番": 10, "馬名": "コスモキュランダ", "性齢": "牡4歳", "騎手": "横山武史", "血統": "アルアイン", "前走": "ジャパンC9着"},
    11: {"枠番": 6, "馬番": 11, "馬名": "ミステリーウェイ", "性齢": "セ7歳", "騎手": "松本大輝", "血統": "ハーツクライ", "前走": "アルゼンチン共和国杯1着"},
    12: {"枠番": 6, "馬番": 12, "馬名": "マイネルエンペラー", "性齢": "牡5歳", "騎手": "丹内祐次", "血統": "ゴールドシップ", "前走": "ジャパンC10着"},
    13: {"枠番": 7, "馬番": 13, "馬名": "アドマイヤテラ", "性齢": "牡4歳", "騎手": "川田将雅", "血統": "スワーヴリチャード", "前走": "京都大賞典4着"},
    14: {"枠番": 7, "馬番": 14, "馬名": "アラタ", "性齢": "牡8歳", "騎手": "大野拓弥", "血統": "キングカメハメハ", "前走": "福島記念1着"},
    15: {"枠番": 8, "馬番": 15, "馬名": "エルトンバローズ", "性齢": "牡5歳", "騎手": "西村淳也", "血統": "ディープブリランテ", "前走": "マイルCS5着"},
    16: {"枠番": 8, "馬番": 16, "馬名": "タスティエーラ", "性齢": "牡5歳", "騎手": "松山弘平", "血統": "サトノクラウン", "前走": "ジャパンC7着"},
}

HORSE_INFO_STR_2025 = """【2025年有馬記念 確定出走馬・詳細解説】
枠1・馬1｜エキサイトバイオ（牡3歳・荻野極・エイシンフラッシュ産駒・前走菊花賞3着）- 3歳世代屈指のスタミナ自慢、中山2500mの適性高い
枠1・馬2｜シンエンペラー（牡4歳・坂井瑠星・Siyouni産駒・前走ジャパンC8着）- 凱旋門賞3着馬ソットサスの全弟、欧州仕込みの重厚な末脚が武器
枠2・馬3｜ジャスティンパレス（牡6歳・団野大成・ディープインパクト産駒・前走ジャパンC5着）- 23年天皇賞(春)覇者、このレースを最後に引退を表明
枠2・馬4｜ミュージアムマイル（牡3歳・C.デムーロ・リオンディーズ産駒・前走天皇賞秋2着）- 25年皐月賞馬、中山コースは3戦2勝と相性抜群
枠3・馬5｜レガレイラ（牝4歳・C.ルメール・スワーヴリチャード産駒・前走エリザベス女王杯1着）- ファン投票1位、昨年の有馬記念を制した現役最強牝馬
枠3・馬6｜メイショウタバル（牡4歳・武豊・ゴールドシップ産駒・前走天皇賞秋6着）- 25年宝塚記念を逃げ切り勝ち、今回もハナを叩く構え
枠4・馬7｜サンライズジパング（牡4歳・鮫島克駿・キタサンブラック産駒・前走チャンピオンズC8着）- 芝・ダート不問のパワーが持ち味、冬の荒れ馬場は歓迎
枠4・馬8｜シュヴァリエローズ（牡7歳・北村友一・キズナ産駒・前走京都大賞典2着）- 24年目黒記念勝ち、晩成のキズナ産駒としてベテランの意地を見せる
枠5・馬9｜ダノンデサイル（牡4歳・戸崎圭太・エピファネイア産駒・前走ジャパンC3着）- 24年日本ダービー馬、直線の急坂を苦にしない勝負根性が持ち味
枠5・馬10｜コスモキュランダ（牡4歳・横山武史・アルアイン産駒・前走ジャパンC9着）- 中山で行われた弥生賞の勝ちっぷりから「中山の鬼」と称される
枠6・馬11｜ミステリーウェイ（セ7歳・松本大輝・ハーツクライ産駒・前走アルゼンチン共和国杯1着）- 東京2500mの重賞勝ちから距離適性を証明、勢い乗る昇り馬
枠6・馬12｜マイネルエンペラー（牡5歳・丹内祐次・ゴールドシップ産駒・前走ジャパンC10着）- ステイヤーとしての資質開花、中山長距離はベスト条件
枠7・馬13｜アドマイヤテラ（牡4歳・川田将雅・スワーヴリチャード産駒・前走京都大賞典4着）- 安定した先行力が武器、鞍上に川田騎手を迎え必勝を期す
枠7・馬14｜アラタ（牡8歳・大野拓弥・キングカメハメハ産駒・前走福島記念1着）- 8歳にして重賞初制覇の勢いそのままに、激走を狙う大ベテラン
枠8・馬15｜エルトンバローズ（牡5歳・西村淳也・ディープブリランテ産駒・前走マイルCS5着）- 毎日王冠勝ちなど1800-2000mが主戦場も、巧みな立ち回りで距離克服狙う
枠8・馬16｜タスティエーラ（牡5歳・松山弘平・サトノクラウン産駒・前走ジャパンC7着）- 23年日本ダービー馬、香港QE2世C勝ちなど国際経験も豊富な実力馬
"""
...
search_query = """
あなたは第70回有馬記念2025(2025年12月28日開催)の予想に資する情報を調査する専門家です。
...
2. 各馬の直近レース内容（最低1走）
　- 距離 / 馬場 / 通過順 / 上がり / 着差
3. 当日(2025年12月28日)の馬体重増減・馬場状態・天候
4. 逃げ・先行馬の想定（ペース判断用）
...
【資金配分の目安】
（上記のパターンそれぞれの資金配分を記載。予算を１万円として、安全型ならどういう配分か、バランス型ならどういう配分か、責型ならどういう配分かを記載。）
